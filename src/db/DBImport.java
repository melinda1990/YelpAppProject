	...
	public static void main(String[] args) {
	  	 try {
			...
			//Step 2: drop tables
	  		...
	  		sql = "CREATE TABLE RESTAURANTS "
	  		 ...
	  		 sql = "CREATE TABLE USER_VISIT_HISTORY (visit_history_id bigint(20)" +
	  		 " unsigned NOT NULL AUTO_INCREMENT, user_id VARCHAR(255) NOT NULL ,"
	  	...
	  	//Step 4: insert into table
	  		BufferedReader reader = new BufferedReader(new FileReader(
	  		  		"F:\\ProjectSoftware\\Data\\yelp_dataset-master\\business_small.json"));//replace with your real physical path. 
